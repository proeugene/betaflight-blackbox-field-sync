...
from bbsyncer.web.server import run_server, _make_handler, _render_index, _resolve_session_path, _HTTPError
...
def storage(tmp_path):
    ...
    manifest = {
        ...
        "fc": {"variant": "BTFL", "uid": "deadbeef12345678", "api_version": "1.45", "blackbox_device": 3},
